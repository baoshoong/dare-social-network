...
import {PostModel} from "../home/home.component";
...
@Component({
  selector: 'app-search',
  standalone: true,
  imports: [PostComponent, MatCardModule, MatFormFieldModule, MatInputModule, FormsModule, PostComponent, AsyncPipe, NgForOf],
